...
// Generated 24-May-2021 02:35:23
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"hoffmansubsystem\" **\n");
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(hoffmansubsystem_M)
                == (NULL)));

#else

      return (!(rtmGetErrorStatus(hoffmansubsystem_M)
                == (NULL)) || rtmGetStopRequested(hoffmansubsystem_M));
    ...
    {
      mRunModel = (rtmGetErrorStatus(hoffmansubsystem_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
